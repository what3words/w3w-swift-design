...
public class W3WWordsView: UILabel {
  ...
  var colors: W3WColors   = .darkBlueGrayRed
  var padding: W3WPadding = .bold


  public init(words: String = "---.---.---", colors: W3WColors = .darkBlueGrayRed, font: UIFont? = nil) {
    self.colors = colors
  ...
  public init(frame: CGRect, words: String = "---.---.---", colors: W3WColors = .darkBlueGrayRed, font: UIFont? = nil) {
    self.colors = colors
