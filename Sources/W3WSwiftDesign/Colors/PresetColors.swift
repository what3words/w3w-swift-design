...
extension W3WColorScheme {
  
  static public let blackGrayRed     = W3WColorScheme(main: .blackGrayRed, brand: .darkBlue, highlight: W3WTwoColor(foreground: .text, background: .darkBlue), border: .mediumGrey, separator: .lightGrey, shadow: .offDarkGrey, placeholder: .mediumGrey, positive: W3WTwoColor(foreground: .white, background: .green), negative: W3WTwoColor(foreground: .white, background: .red))
  static public let darkBlueGrayRed  = W3WColorScheme(main: .darkBlueGrayRed, brand: .darkBlue, highlight: W3WTwoColor(foreground: .text, background: .darkBlue), border: .mediumGrey, separator: .lightGrey, shadow: .offDarkGrey, placeholder: .mediumGrey, positive: W3WTwoColor(foreground: .white, background: .green), negative: W3WTwoColor(foreground: .white, background: .red))
