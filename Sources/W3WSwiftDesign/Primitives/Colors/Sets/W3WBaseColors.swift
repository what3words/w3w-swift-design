...
public class W3WBaseColors {
  ...
  public func findTint() -> W3WColor? {
    if let c = self as? W3WColorScheme {
      return c.tint
    }
  ...
  public func asColorScheme() -> W3WColorScheme {
    if let colorScheme = self as? W3WColorScheme {
      return colorScheme
    } else {
      return W3WColorScheme(colors: self.asColorSet())
    }
  }
