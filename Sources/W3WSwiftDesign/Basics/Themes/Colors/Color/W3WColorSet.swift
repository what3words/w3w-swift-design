...
public class W3WColorSet {
  ...
  public init(foreground: W3WColor? = nil, background: W3WColor? = nil, tint: W3WColor? = nil, secondary: W3WColor? = nil, brand: W3WColor? = nil, highlight: W3WBasicColors? = nil, border: W3WColor? = nil, separator: W3WColor? = nil, shadow: W3WColor? = nil, placeholder: W3WColor? = nil, error: W3WBasicColors? = nil, header: W3WBasicColors? = nil) {
...
//    super.init(foreground: main.foreground, background: main.background)
  ...
  /// initialise with a foreground, background, highlight and secondary colour
  public init(uiForeground: UIColor? = nil, uiBackground: UIColor? = nil, uiTint: UIColor? = nil, uiSecondary: UIColor? = nil, uiBrand: UIColor? = nil, highlight: W3WBasicColors? = nil, uiBorder: UIColor? = nil, uiSeparator: UIColor? = nil, uiShadow: UIColor? = nil, uiPlaceholder: UIColor? = nil, error: W3WBasicColors? = nil, header: W3WBasicColors? = nil) {
...
//  }
  ...
  public func with(foreground: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  ...
  /// return the same colorset the secondary color changed
  public func with(brand: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }

  
  /// return the same colorset the highlight color changed
  public func with(highlight: W3WBasicColors? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  

  /// return the same colorset the positive color changed
  public func with(border: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  
  
  /// return the same colorset the positive color changed
  public func with(separator: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  
  
  /// return the same colorset the secondary color changed
  public func with(shadow: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  
  
  /// return the same colorset the positive color changed
  public func with(placeholder: W3WColor? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  
  
  /// return the same colorset the positive color changed
  public func with(error: W3WBasicColors? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  
  
  /// return the same colorset the positive color changed
  public func with(header: W3WBasicColors? = nil) -> W3WColorSet {
    return W3WColorSet(foreground: foreground, background: background, tint: tint, secondary: secondary, brand: brand, highlight: highlight, border: border, separator: separator, shadow: shadow, placeholder: placeholder, error: error, header: header)
  }
  ...
  public func asColors() -> W3WColors {
    return W3WColors(base: self)
  }
